Backup written to '/var/opt/tableau/tableau_server/data/tabsvc/files/backups/backup-2024-03-04.tsbak' on the controller node.
Traceback (most recent call last):
  File "backup.py", line 58, in <module>
